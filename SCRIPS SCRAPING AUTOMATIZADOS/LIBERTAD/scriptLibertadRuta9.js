...
async function scrapeData() {
  ...
  const linksCategorias = [
    'https://www.hiperlibertad.com.ar/almacen/desayuno-y-merienda/galletitas-dulces?sc=4',
    'https://www.hiperlibertad.com.ar/almacen/desayuno-y-merienda/galletitas-saladas?sc=4',
    'https://www.hiperlibertad.com.ar/almacen/desayuno-y-merienda/cereales?sc=4',
    'https://www.hiperlibertad.com.ar/almacen/desayuno-y-merienda/bizcochuelos-budines-y-magdalenas?sc=4',
    'https://www.hiperlibertad.com.ar/almacen/para-preparar?sc=4',
    'https://www.hiperlibertad.com.ar/bebidas/jugos/en-polvo?sc=4',
    'https://www.hiperlibertad.com.ar/almacen/golosinas-y-chocolates?sc=4',
    'https://www.hiperlibertad.com.ar/almacen/aceites-y-vinagres/aceites/aceites-de-girasol/aceites-de-oliva/aceites-mezcla/otras-variedades-de-aceites?initialMap=c,c&initialQuery=almacen/aceites-y-vinagres&map=category-1,category-2,category-3,category-3,category-3,category-3,category-3&sc=4',
    'https://www.hiperlibertad.com.ar/almacen/golosinas-y-chocolates?sc=4',
    'https://www.hiperlibertad.com.ar/almacen/arroz-y-legumbres/arroz?initialMap=c,c&initialQuery=almacen/arroz-y-legumbres&map=category-1,category-2,category-3&sc=4',
    'https://www.hiperlibertad.com.ar/almacen/panificados?sc=4',
    'https://www.hiperlibertad.com.ar/almacen/pastas-secas-y-salsas?sc=4',
    'https://www.hiperlibertad.com.ar/almacen/snacks?sc=4',
    'https://www.hiperlibertad.com.ar/lacteos/yogures?sc=4',
    'https://www.hiperlibertad.com.ar/limpieza/papeles/papel-higienico?sc=4',
    'https://www.hiperlibertad.com.ar/perfumeria/cuidado-personal/jabones?sc=4',
    'https://www.hiperlibertad.com.ar/bebidas/cervezas?sc=4',
    'https://www.hiperlibertad.com.ar/bebidas/gaseosas?sc=4',
    'https://www.hiperlibertad.com.ar/bebidas/aguas/aguas-saborizadas?sc=4',
  ...
  try {
    console.log(" ");
    console.log(chalk.green.underline('                         [SUCURSAL LIBERTAD RUTA 9]                         '));
    console.log(" ");
...
async function createExcel(rows) {
  ...
  const fileName= 'Libertad_Ruta9'+fechaConSeparador+'.xlsx';
