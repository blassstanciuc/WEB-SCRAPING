...
async function scrapeData() {
  ...
  // CATEGORIAS NUEVAS
  "https://www.masonline.com.ar/desayunos-y-meriendas/galletitas-saladas"
  ...
  try {
    console.log(" ");
    console.log(chalk.green.underline('                         [SUCURSAL MAS ONLINE CONSTITUYENTE]                         '));
    console.log(" ");
      ...
      for (const producto of allProductos) {  
        try {
          const resultado = await page.evaluate((Productos) => {
            ...
            //SUCURSAL
            arrayProductos.push("Constituyente");
            //FECHA
...
async function createExcel(rows) {
  ...
  const fileName= 'masOnlineConstituyente_'+fechaConSeparador+'.xlsx';
